...
* [Bitcoin Core](https://github.com/bitcoin/bitcoin) version equal or above [23.0](https://bitcoincore.org/bin/bitcoin-core-23.0/test.rc2/) (`bobs` requires [this](https://github.com/bitcoin/bitcoin/pull/22918) functionality).
